const styles = {
  ...
  productDiscountPrice:
    "font-bold text-[12px] 800px:text-[18px] text-[#333] font-Roboto",
  price:
    "font-[500] text-[12px] 800px:text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  ...
  cart_button:
    "px-[20px] h-[38px] rounded-[10px] bg-[#f63b60] flex items-center justify-center cursor-pointer",
  cart_button_text: "text-[#fff] text-[16px]",
